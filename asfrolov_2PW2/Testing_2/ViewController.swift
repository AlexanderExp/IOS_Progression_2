...
#selector(incrementButtonPressed), for: .touchUpInside)
    ...
    private func setupCommentView() -> UIView {
        ...
        commentLabel.text = "Ключ поверни и ПА-ЛЕ-ТЕ-ЛИ"
    ...
    private func setupMenuButtons() {
        let colorsButton = makeMenuButton(title: "HL 1 ")
     
        let notesButton = makeMenuButton(title: "HL 2 ")
                                         
        let newsButton = makeMenuButton(title: "HL 2+ ")
